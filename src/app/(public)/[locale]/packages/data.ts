...
export const ACTIVITIES: Activity[] = [
  ...
  { id: "dinner", name: "Romantic Dinner", emoji: "🌅", price: 1500, unit: "/person", inCart: true, desc: "A private romantic dinner set up in a stunning location, arranged around your preferences and special occasion." },
  ...
  { id: "xplor", name: "Xplor Park", emoji: "🌴", price: 3500, unit: "/person", inCart: true, desc: "An adrenaline-packed adventure park through the jungle — zipline circuits, amphibious vehicles, rafts on underground rivers, and stalactite caves." },
  { id: "xplorfuego", name: "Xplor Fuego", emoji: "🔥", price: 3100, unit: "/person", inCart: true, desc: "The nighttime edition of Xplor — the same jungle adventure circuits illuminated after dark for a completely different thrill. Open 5:30 PM – 11:00 PM." },
  ...
  { id: "tennis", name: "Tennis Lessons", emoji: "🎾", price: 800, unit: "/hour", inCart: false, desc: "Private tennis lessons with a local instructor, 800 MXN per hour. Our team will confirm hours and charge separately." },
];
